...
function BalanceGauge({ label, value }: { label: string; value: number }) {
...
export function BalancePanel({ data }: { data: BalanceResult }) {
  return (
    <div className="space-y-4">
      <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Visual Balance</h3>

      <div className="grid sm:grid-cols-2 gap-4">
        <BalanceGauge label="Horizontal Balance" value={data.horizontalBalance} />
        <BalanceGauge label="Vertical Balance" value={data.verticalBalance} />
      </div>
